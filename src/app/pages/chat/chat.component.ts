...
export class ChatComponent {
  ...
  contactsList: any[] = [
    ...
    { image: '../../../assets/friend1.png', name: 'Julián Baldaro', lastMessage: 'Nos vemos capo', read: true },
    { image: '../../../assets/friend5.png', name: 'Marcelo Peralta', lastMessage: 'Visto la semana pasada', read: false },
  ]
